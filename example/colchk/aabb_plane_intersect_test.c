...
void output(zPlane3D *p, zAABox3D *b, zVec3D ip[], int n, const char filename[])
{
  ...
  fprintf( fp, "vert 0: " ); zVec3DDataFWrite( fp, &v[0] );
  fprintf( fp, "vert 1: " ); zVec3DDataFWrite( fp, &v[1] );
  fprintf( fp, "vert 2: " ); zVec3DDataFWrite( fp, &v[2] );
  fprintf( fp, "vert 3: " ); zVec3DDataFWrite( fp, &v[3] );
