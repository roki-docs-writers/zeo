...
void output(zTri3D *t, zAABox3D *b, zVec3D ip[], int n)
{
  ...
  fprintf( fp, "vert 0: " ); zVec3DDataFWrite( fp, zTri3DVert(t,0) );
  fprintf( fp, "vert 1: " ); zVec3DDataFWrite( fp, zTri3DVert(t,1) );
  fprintf( fp, "vert 2: " ); zVec3DDataFWrite( fp, zTri3DVert(t,2) );
