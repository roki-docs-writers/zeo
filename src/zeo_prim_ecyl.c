...
zECyl3D *zECyl3DMirror(zECyl3D *src, zECyl3D *dest, zAxis axis)
{
  ...
  zVec3DElem(zECyl3DCenter(dest,0),axis) *= -1;
  zVec3DElem(zECyl3DCenter(dest,1),axis) *= -1;
  zVec3DElem(zECyl3DRadVec(dest,0),axis) *= -1;
  zVec3DElem(zECyl3DRadVec(dest,1),axis) *= -1;
